...
import { Mail, Check, AlertCircle, CheckCircle, RefreshCw, ArrowLeft } from 'lucide-react';
...
const EmailVerification = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Ocorreu um erro ao verificar seu email. Tente novamente.');
    } finally {
      setIsLoading(false);
    }
  };
              ...
              {!isVerified ? (
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="font-medium text-lg mt-1">{email || 'seu@email.com'}</p>
                    <p className="text-sm text-muted-foreground mt-4">
                      Digite o código de 6 dígitos para verificar sua conta
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <Link 
                        to={accountType ? `/register?type=${accountType}` : '/register'}
