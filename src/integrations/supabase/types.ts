  ...
  public: {
    Tables: {
      ...
      virtual_try_ons: {
        ...
        Relationships: [
          {
            foreignKeyName: "virtual_try_ons_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "virtual_try_ons_hairstyle_id_fkey"
    ...
    Functions: {
      ...
      get_recommendations_by_face_shape: {
        Args: {
          face_shape: string
        }
        Returns: {
    ...
    Enums: {
      user_role: "client" | "barber" | "barbershop_owner" | "admin"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
